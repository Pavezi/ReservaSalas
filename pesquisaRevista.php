...
<div class="container-fluid" style="margin-top: 30px">
		<div class="row">
			<div class="col-sm-12">
				...
				<h2>
					<i>Pesquisa Revista</i>
				</h2>
				<br>
				<form name="form_pesquisa" id="form_pesquisa" method="post" 
					action="pesquisaRevista.php">
					<fieldset>
						<legend>Digite o nome da revista</legend>
						<div class="input-prepend">
							<input type="text" name="nome_revista" id="nome_revista" required="required"
								value="" tabindex="1" placeholder="Pesquisar nome da revista..." />
						</div>
...
if (isset($_POST["nome_revista"])) {
    
    $revista = new Revista();
    $revista->setNome_revista($_POST["nome_revista"]);
    
    try {
        $result = $revista->SelecionaDados($revista->getNome_revista());
...
<form action='excluiRevista.php' method='post' style='padding: 0px; background-color: #FFF;'>
<input type='hidden' name='codigo_revista' value=" . $res['codigo_revista'] . " /> <button style='border:0px; background-color: #FFF; cursor: pointer; '> <img src='imagens/excluir.png' style='height: 35px; width: 35px;  padding:3px; '> </button>
</form>
</td>";
                $msg .= "                    <td class='filterable-cell'>" . $res['nome_revista'] . "</td>";
                $msg .= "                    <td class='filterable-cell'>" . $res['tema_revista'] . "</td>";
                $msg .= "                    <td class='filterable-cell'>" . $res['ano'] . "</td>";
                $msg .= "                    <td class='filterable-cell'>" . $res['numero'] . "</td>";
                $msg .= "                    <td class='filterable-cell'>" . $res['issn'] . "</td>";
