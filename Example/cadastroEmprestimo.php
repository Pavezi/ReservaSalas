...
if (isset($_POST["status"])) {
    ...
    $emprestimo->setCodigo_livro($_POST["livro"]);
    $emprestimo->setCodigo_revista(0);
...
<div class="container-fluid" style="margin-top: 30px">
		<div class="row">
			<div class="col-sm-12">
				...
				<form id="loja" action="cadastroEmprestimo.php" method="post" onsubmit="this.submit(); this.reset(); return false;">
					<h2><i>CADASTRO EMPRÉSTIMO LIVRO</i></h2>
					<br>
					...
					?>
						...
						<label for="lbl_livro"><b>LIVRO</b></label>
					<select  name = 'livro' >

					<?php 
					$livro = new Livro();
					
					$result = $livro->SelecionaDadosGerais();
					
					if ($result->num_rows != 0) {
					    foreach ($result as $res) {
					        $codigo = $res['codigo_livro'];
					        $nome = $res['titulo_livro'];
					        echo "<option value =  $codigo> $nome</option>";
